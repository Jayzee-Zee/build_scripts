...
repo init -u https://github.com/LMODroid/manifest.git -b fourteen --git-lfs --depth=1
#clone dev tree
git clone https://github.com/Jayzee-Zee/android_device_xiaomi_earth -b LMO device/xiaomi/earth 
...
# Build the ROM
chmod 777 vendor/lmodroid/config/common_full_phone.mk
chmod 777 vendor/lmodroid/config/*.mk
lunch lmodroid_earth-userdebug || lunch lmodroid_earth-ap2a-userdebug || breakfast earth userdebug
